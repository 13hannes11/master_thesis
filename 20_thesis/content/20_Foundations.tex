...
ResNet was introduced by \textcite{he2016deep}

A basic residual block consists ... (see \autoref{fig:Foundations:ANNs:Architecture:ResNet:Block}).
...
\begin{figure}
    ...
    \begin{tikzpicture}[rotate=90,transform shape]
        ...
        \node[functions, below of=conv2] (plus) {+};
