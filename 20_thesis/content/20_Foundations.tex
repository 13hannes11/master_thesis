...
The slides prepared using the Kato-Katz are, after a resting period, examined under a microscope to count the number of eggs per milligram. This allows to identify the intensity of infection of a patient \cite{feasey2010neglected}. \todo{Whole slide imaging} \todo{z-stacking}
