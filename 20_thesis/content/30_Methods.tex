...
The utilized hardware for training models was a machine running Ubuntu 20.04.3 with a Ryzen 5 2600X processor, 64 GiB of RAM, and an Nvidia GeForce RTX 2070 (8 GiB) graphics card.
...
\section{Implementation of Traditional Focusing Methods}
\label{sec:Methods:Traditional}
