...
\begin{figure}
    ...
    \end{subfigure}%
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{images/40_results/histogram_predictions_targets_cnn.pdf}
        \caption{\acs{poop}-\acs{cnn}}
    ...
    \todo[inline]{Figure axis should have same scale. If possible and there is time potentially generate one histogram with three bars.}
\end{figure}
...
\begin{table}
    \centering
    \caption{Comparing \acs{poop} to other methods in terms of \ac{mae} of image indices compared to the best in-focus image from a focus stack.}
    \begin{tabular}{lrrrrr}
        \hline
...
\begin{figure}
    ...
    \caption{Comparing \acs{poop} to other methods in terms of \ac{mae}$^*$ of image indices compared to the best in-focus image from a focus stack. The same data is also presented in \autoref{tab:Results:Comparison:RelatedWorks:IndexMAE}.}
