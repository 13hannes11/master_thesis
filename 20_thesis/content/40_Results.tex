...
This section contains visualizations of focus stacks and individual images that are all taken from the same focus stack. One image of this focus stack is shown in \autoref{fig:Results:Stack:ImageSliceVisualisation}. Later, \autoref{fig:Results:Stack:SideBySide} shows slices of different images of the same focus stack. \autoref{fig:Results:Stack:ImageSliceVisualisation} describes where the slices are taken from. The image shown has the stack index 4.
